customElements.define("gender-display", class GenderDisplay extends HTMLElement {

    constructor() {
        super();
        this.appendChild(document.getElementById("gender-display").content.cloneNode(true));
    }
